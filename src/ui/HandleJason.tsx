          ...
          >
            {jasonBracketGuides && id !== " " && (
              <>
                ...
                <div
                  className={`absolute z-[-1] h-[1px] top-[calc(50%-1px)] opacity-60`}
                  style={
                    {
...
export function HandleJason2({ data }: any) {
  ...
  async function recomputeTree() {
    if (treeRef.current) {
      ...
      // jasonMemoValues.current = new Map(); //down v
    }
  }
    ...
    () =>
      throttle((e: any) => {
        ...
        if (
          ...
          $jasonHeader.style.height = "3.75rem";
